...
meta:
	ADDON_NAME = ofxPatches
	ADDON_DESCRIPTION = "Visual programming tool for creating a pipeline of visual effects."
	ADDON_AUTHOR = @paulobarcelos
	ADDON_TAGS = "tool" "node" "flow programming" "visual programming"
	ADDON_URL = http://github.com/paulobarcelos/ofxPatches
